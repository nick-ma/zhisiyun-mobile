(function(e) {
    e.jqmCalendar = function(t, n) {
        function h() {
            ...
            l = e("<a href='#' data-role='button' data-icon='arrow-l' data-iconpos='notext' class='previous-btn'>Previous</a>").data("date", d(i.settings.date, -1)).appendTo(p);
            u = e("<span/>").appendTo(p);
            c = e("<a href='#' data-role='button' data-icon='arrow-r' data-iconpos='notext' class='next-btn'>Next</a>").data("date", d(i.settings.date, 1)).appendTo(p);
            l.click(function(t) {
            ...
            o.appendTo(s);
            f = e("<ul data-role='listview' data-inset='false' data-theme='" + i.settings.dataTheme + "' data-divider-theme='" + i.settings.dividerTheme + "' />").insertAfter(o);
        ...
        function S(t, n) {
            ...
            if ((l + f) / 7 - c === 0) c++;
            a.empty();
            u.html(i.settings.months[o] + " " + r.toString());
        ...
        function T(t, n) {
            ...
            if (r == s) {
                t.find("p").append("<strong>" + n.summary + "</strong> </p><p>" + r)
            } else {
                t.find("p").append("<strong>" + n.summary + "</strong> </p><p>" + r + "&nbsp;&nbsp;&rarr;&nbsp;&nbsp;" + s)
        ...
        function N(t) {
            ...
            if (t.length) {
                ...
                for (var r = 0, s; s = t[r]; r++) {
                    ...
                    var u = e("<li class='ui-event-item'><a href='" + s.url + "' class='event-item-link' rel='" + s.eid + "'><h3></h3><p></p></a></li>").appendTo(f);
                    i.settings.listItemFormatter(u, s)
                }
            } else {
                var u = e("<li class='ui-event-item'><p style='padding-top:0.65em;'><strong>当月没有任务条目</strong></p></li>").appendTo(f)
            }
        ...
        var i = this;
        i.settings = null;
        var s = e(t).addClass("jqm-cal-wrapper"),
            o, u, a, f, l, c;
        s.bind("change", function(t, n) {
            ...
            for (var o = 0, t; t = i.settings.events[o]; o++) {
                if (t[i.settings.end] >= n && t[i.settings.begin] < r) {
                    var u = e("<li class='ui-event-item'><a href='" + t.url + "' class='event-item-link' rel='" + t.eid + "'><h3></h3><p></p></a></li>").appendTo(f);
                    i.settings.listItemFormatter(u, t);
                    s = true
                }
            }
            if (!s) var u = e("<li class='ui-event-item'><p style='padding-top:0.65em;'><strong>选定的日期没有任务条目</strong></p></li>").appendTo(f);
            f.trigger("create").filter(".ui-listview").listview("refresh")
        });
