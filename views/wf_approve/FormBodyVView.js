...
define(["jquery", "underscore", "backbone", "handlebars", "moment"],
    function($, _, Backbone, Handlebars, moment) {
        ...
        Handlebars.registerHelper('renderFieldTitle2', function(row, col) {
            var field = get_field2(row, col);
            if (field) {
                var ret = [];
        ...
        Handlebars.registerHelper('renderFieldElement2', function(row, col) {
            var field = get_field2(row, col);
            if (field) {
                var common_attr = [];
        ...
        var View = Backbone.View.extend({
            ...
            initialize: function() {
                this.el = '#form_body';
                this.template = Handlebars.compile($("#tmp_form_body2").html());
